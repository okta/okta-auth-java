...
In your browser, navigate to: [https://github.com/okta/okta-auth-java](https://github.com/okta/okta-auth-java)
...
``` bash
$ git clone https://github.com/YOUR_ACCOUNT/okta-auth-java.git
$ cd okta-auth-java
$ git remote add upstream https://github.com/okta/okta-auth-java.git
$ git checkout master
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/okta-auth-java](https://github.com/YOUR_ACCOUNT/okta-auth-java)
