...
public class InvalidAuthenticationStateException extends AuthenticationException {
    ...
    public static final String ERROR_CODE = "E0000079";

    public InvalidAuthenticationStateException(Error error) {
        super(error);
    }

    public InvalidAuthenticationStateException(ResourceException e) {
        super(e);
    }
}