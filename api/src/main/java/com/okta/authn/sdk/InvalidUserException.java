...
/**
 * Recovery or other state is not allowed for user. This exception
...
public class InvalidUserException extends AuthenticationException {
    ...
    public static final String ERROR_CODE = "E0000095";

    public InvalidUserException(Error error) {
        super(error);
    }

    public InvalidUserException(ResourceException e) {
        super(e);
    }
}