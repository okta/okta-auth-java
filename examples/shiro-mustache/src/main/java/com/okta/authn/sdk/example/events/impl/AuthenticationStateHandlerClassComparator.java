 ...
 * @since 1.3
 */
public class AuthenticationStateHandlerClassComparator implements Comparator<AuthenticationStatus> {

    @SuppressWarnings("unchecked")
    public int compare(AuthenticationStatus a, AuthenticationStatus b) {
