...
public class DefaultUnlockAccountRequest extends AbstractResource implements UnlockAccountRequest {
    ...
    public DefaultUnlockAccountRequest(InternalDataStore dataStore, Map<String, Object> properties) {
    ...
    @Override
    public UnlockAccountRequest setRelayState(String relayState) {
    ...
    @Override
    public UnlockAccountRequest setUsername(String username) {
