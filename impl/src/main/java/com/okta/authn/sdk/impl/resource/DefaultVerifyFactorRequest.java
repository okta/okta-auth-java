...
public class DefaultVerifyFactorRequest extends AbstractResource implements VerifyFactorRequest {

    private static final StringProperty STATE_TOKEN_PROPERTY = new StringProperty("stateToken");

    public DefaultVerifyFactorRequest(InternalDataStore dataStore) {
        super(dataStore);
    }

    public DefaultVerifyFactorRequest(InternalDataStore dataStore, Map<String, Object> properties) {
